  ...
  Future<void> seedIfEmpty() async {
    ...
    final achievements = <Achievement>[
      ...
      Achievement(
        id: _uuid.v4(),
        title: '10000 XP',
        description: 'Earn a total of 10000 XP.',
        icon: 'bolt',
        triggerType: AchievementTriggerType.totalXp,
        targetValue: 10000,
      ),
      ...
      Achievement(
        id: _uuid.v4(),
        title: '10000 Productive Points',
        description: 'Accumulate 10000 total good-activity points.',
        icon: 'trending_up',
        triggerType: AchievementTriggerType.productivePoints,
        targetValue: 10000,
      ),
      ...
      Achievement(
        id: _uuid.v4(),
        title: 'Best Day: 500 XP',
        description: 'Earn 500 XP in a single day.',
        icon: 'bolt',
        triggerType: AchievementTriggerType.bestDayXp,
        targetValue: 500,
      ),
      Achievement(
        id: _uuid.v4(),
        title: 'Best Day: Level 5',
        description: 'Reach level 5 within a single day.',
        icon: 'military_tech',
        triggerType: AchievementTriggerType.bestDayLevel,
        targetValue: 5,
      ),
    ];
